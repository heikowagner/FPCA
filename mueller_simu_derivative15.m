...
dlmwrite('mean15.csv', [ meanM(1:2,:) ; round( meanM(3:5,:)*10,2) ]', 'precision','%.2f')
dlmwrite('varV15.csv', [ varV(1:2,:) ; round( varV(3:5,:)*10^3,2) ]', 'precision','%.2f')
dlmwrite('medM15.csv', [ medM(1:2,:) ; round( medM(3:5,:)*10^1,2) ]', 'precision','%.2f')
dlmwrite('iqrM15.csv', [ iqrM(1:2,:) ; round( iqrM(3:5,:)*10^1,2) ]', 'precision','%.2f')
dlmwrite('meanPhi15.csv', [ meanPhi(1:2,:) ; round( meanPhi(3:8,:)*10^1,2) ]', 'precision','%.2f')
dlmwrite('meedianPhi15.csv', [ medianPhi(1:2,:) ; round( medianPhi(3:8,:)*10^1,2) ]', 'precision','%.2f')
dlmwrite('eigenvalues15.csv', [ eigenvalues(1:2,:) ; round( eigenvalues(3:6,:)*10^10,2) ]', 'precision','%.2f')
dlmwrite('medianeigenvalues15.csv', [ Medeigenvalues(1:2,:) ; round( Medeigenvalues(3:6,:)*10^10,2) ]', 'precision','%.2f')
dlmwrite('meanScores15.csv', [ meanScores(1:2,:) ; round( meanScores(3:6,:)*10,2) ]', 'precision','%.2f')
dlmwrite('medianScores15.csv', [ medianScoresa(1:2,:) ; round( medianScoresa(3:6,:)*10,2) ]', 'precision','%.2f')

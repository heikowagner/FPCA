...
ncohort=100;    %200 subjects in the simulated data
lint=1;
y=cell(1,ncohort);
t=cell(1,ncohort);
newy = y;
...
% 		  'designPlot',0,'numBins',0, 'nder',0:2,'newdata',linspace(0,1,ngrid), 'ngrid',ngrid,'verbose','off');  
% 
% p = setDerOptions('selection_k', 2,'screePlot',0, 'corrPlot',0,...
% 		  'designPlot',0,'numBins',15, 'kernel', 'epan',  'nder',0:2, 'rho',1,'verbose','off')     
...
[hX2b, V2b, loadsb,Meansmo2bb,Db,x]=fpca(2,0,3,0,1,Xc,Yc,0,0,1,0,0);
...
[hX1bd, V2b, loadsb,Meansmo2bb,Db,xd]=fpca(2,0,1,0,1,Xc,Yc,0,0,'d',0,0);
[hX1b, V2b, loadsb,Meansmo2bb,Db,x]=fpca(2,0,1,0,1,Xc,Yc,0,0,0,0,0);

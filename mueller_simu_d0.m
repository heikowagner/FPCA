...
%g1(x)=sqrt(2)*(0.5*(3*x.^2-1)/sqrt( int(0.5^2*(3*x.^2-1)^2, x,-1,1))  )
%g2(x)=sqrt(2)*(1/8*(63*x.^5-70*x.^3+15*x)/sqrt( int(1/8^2*(63*x.^5-70*x.^3+15*x)^2, x,-1,1))  )


%g1(x)=2*(0.5*(3*x.^2-1)/sqrt( int(0.5^2*(3*x.^2-1)^2, x,-1,1))  )
%g2(x)=2*(1/8*(63*x.^5-70*x.^3+15*x)/sqrt( int(1/8^2*(63*x.^5-70*x.^3+15*x)^2, x,-1,1))  )

%g1(x)=2*legendreP(3,x)/sqrt( int(legendreP(3,x)^2, x,-1,1))  
%g2(x)=2*legendreP(8,x)/sqrt( int(legendreP(8,x)^2, x,-1,1))  

%g1(x)=2*legendreP(2,x)
%g2(x)=2*legendreP(7,x)


% g1(x)=sin( x*(2*pi) )/int( sin( x*(2*pi) )^2 ,x,-1,1)
% g2(x)=cos(x*pi)/int( cos( x*pi )^2 ,x,-1,1)
g1(x)=sin( x*(4*pi) )
g2(x)=cos(2*x*pi)
